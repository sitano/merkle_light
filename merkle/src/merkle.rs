...
impl<T: Ord + Clone+AsRef<[u8]>, A: Algorithm<T> + Hasher + Default> MerkleTree<T, A> {
...
impl<T: Ord + Clone+AsRef<[u8]>, A: Algorithm<T> + Hasher + Default> FromIterator<T> for MerkleTree<T, A> {
...
impl<T: Ord + Clone+AsRef<[u8]>, A: Algorithm<T> + Hasher + Default> ops::Deref for MerkleTree<T, A> {
    type Target = [T];
